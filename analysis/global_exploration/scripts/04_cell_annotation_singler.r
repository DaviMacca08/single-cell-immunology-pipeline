...
cd_harmony <- readRDS(
  file.path(paths$objects_global, "srt_obj_merge_harmony.rds")
)
...
message("Saved plot: SingleR_CellAtlas_ScoreHeatmap.pdf")
...
message("Saved plot: SingleR_Monaco_ScoreHeatmap.pdf")
...
message("Saved plot: SingleR_CellAtlas_DeltaDistribution.pdf")
...
message("Saved plot: SingleR_Monaco_DeltaDistribution.pdf")
...
message("Saved plot: CellAtlas_Cluster_Annotation_Heatmap.pdf")
...
message("Saved plot: MonacoImmune_Cluster_Annotation_Heatmap.pdf")
...
save_rds(cd_harmony, filename = "srt_obj_annotated_SingleR.rds", dir = paths$objects_global)
