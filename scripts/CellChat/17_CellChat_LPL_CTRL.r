# =========================================================
# CellChat cell-cell communication analysis - LPL CTRL
# =========================================================
# Input:
#   - Seurat object of LPP compartment Control with consensus annotation
#
# Output:
#   - CellChat object
...
message("Starting CellChat analysis for LPL compartment Control...")
...
lpl_cells_ctrl <- subset(lpl_cells, disease == "Control")

data_input <- GetAssayData(lpl_cells_ctrl, assay = "RNA", layer = "data")
labels <- Idents(lpl_cells_ctrl)
sample_id <- as.factor(lpl_cells_ctrl$sample_id)
disease <- lpl_cells_ctrl$disease
...
open_png(filename = "CellChat_LPL_CTRL_global_network_count.png", dir = paths$plots_cellchat_lpl,
...
open_png(filename = "CellChat_LPL_CTRL_global_network_strength.png", dir = paths$plots_cellchat_lpl,
...
open_png(filename = "CellChat_LPL_CTRL_outgoing_networks_all_groups.png", dir = paths$plots_cellchat_lpl,
...
open_png(filename = "CellChat_LPL_CTRL_incoming_networks_all_groups.png", dir = paths$plots_cellchat_lpl,
         width = 3000, height = 3000)
...
open_png(filename = "CellChat_LPL_CTRL_rankNet.png", dir = paths$plots_cellchat_lpl,
...
for (pw in pathways_all) {
  ...
  open_png(filename = paste0("CellChat_LPL_CTRL_", pw, "_circle.png"), dir = paths$plots_cellchat_lpl_path, 
  ...
  save_plot(p, filename = paste0("CellChat_LPL_CTRL_", pw, "_contribution.png"), dir = paths$plots_cellchat_lpl_path )
...
open_png(filename = "CellChat_LPL_CTRL_signalingRole_scatter.png", dir = paths$plots_cellchat_lpl,
...
open_png(filename = "CellChat_LPL_CTRL_signalingRole_heatmap_outgoing.png", dir = paths$plots_cellchat_lpl,
...
open_png(filename = "CellChat_LPL_CTRL_signalingRole_heatmap_incoming.png", dir = paths$plots_cellchat_lpl,
         width = 1000, height = 1500)
...
message("Saving CellChat object for LPL CTRL...")

message(
  "Final CellChat object for LPL Control contains ",
...
save_rds(cellchat_obj, "cellchat_LPL_CTRL.rds", dir = paths$objects_cellchat)
...
save_session_info(filename = "sessionInfo_CellChat_LPL_CTRL.txt", dir = paths$logs, label = "CellChat cell-cell communication analysis - LPL compartment (Control)")
...
message("=================================================")
message("[PIPELINE] CellChat analysis completed successfully for LPL compartment (Control condition).")
message("=================================================")
