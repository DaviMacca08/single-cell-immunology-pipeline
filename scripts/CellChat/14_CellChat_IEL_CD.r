# =========================================================
# CellChat cell-cell communication analysis - IEL CD
# =========================================================
# Input:
#   - Seurat object of IEL compartment Crohn's disease with consensus annotation
#
# Output:
#   - CellChat object
...
message("Starting CellChat analysis for IEL compartment Crohn's disease...")
...
iel_cells_cd <- subset(iel_cells, disease == "CD")

data_input <- GetAssayData(iel_cells_cd, assay = "RNA", layer = "data")
labels <- Idents(iel_cells_cd)
sample_id <- as.factor(iel_cells_cd$sample_id)
disease <- iel_cells_cd$disease
...
open_png(filename = "CellChat_IEL_CD_global_network_count.png", dir = paths$plots_cellchat_iel,
...
open_png(filename = "CellChat_IEL_CD_global_network_strength.png", dir = paths$plots_cellchat_iel,
...
open_png(filename = "CellChat_IEL_CD_outgoing_networks_all_groups.png", dir = paths$plots_cellchat_iel,
...
open_png(filename = "CellChat_IEL_CD_incoming_networks_all_groups.png", dir = paths$plots_cellchat_iel,
         width = 3000, height = 3000)
...
open_png(filename = "CellChat_IEL_CD_rankNet.png", dir = paths$plots_cellchat_iel,
...
for (pw in pathways_all) {
  ...
  open_png(filename = paste0("CellChat_IEL_CD_", pw, "_circle.png"), dir = paths$plots_cellchat_iel_path, 
  ...
  save_plot(p, filename = paste0("CellChat_IEL_CD_", pw, "_contribution.png"), dir = paths$plots_cellchat_iel_path)
...
open_png(filename = "CellChat_IEL_CD_signalingRole_scatter.png", dir = paths$plots_cellchat_iel,
...
open_png(filename = "CellChat_IEL_CD_signalingRole_heatmap_outgoing.png", dir = paths$plots_cellchat_iel,
...
open_png(filename = "CellChat_IEL_CD_signalingRole_heatmap_incoming.png", dir = paths$plots_cellchat_iel,
         width = 1000, height = 1500)
...
message("Saving CellChat object for IEL CD")

message(
  "Final CellChat object for IEL CD contains ",
...
save_rds(cellchat_obj, "cellchat_IEL_CD.rds", dir = paths$objects_cellchat)
...
save_session_info(filename = "sessionInfo_CellChat_IEL_CD.txt", dir = paths$logs, label = "CellChat cell-cell communication analysis - IEL compartment (Crohn's disease)")
...
message("=================================================")
message("[PIPELINE] CellChat analysis completed successfully for IEL compartment (Crohn's disease condition).")
message("=================================================")
