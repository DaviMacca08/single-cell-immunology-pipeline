---
title: "Functional Enrichment Analysis (GSEA) of Intestinal IEL and LPL Compartments: Disease-Associated Transcriptional Programs in Crohn's Disease"
...
-   pre-ranked GSEA per cell type, using the DESeq2 Wald statistic as
    ranking metric
-   functional interrogation of four curated gene set collections:
    MSigDB Hallmark, Reactome, GO Biological Process (semantically
    simplified), and MSigDB C7 ImmunoSigDB
...
```{r GSEA_Hallmark_IELTH17}
knitr::include_graphics(file.path("../../results/plots/GSEA_IEL/GSEA_Hallmark_IELTH17.png"))
```

**Reactome**

```{r GSEA_Reactome_IELTH17}
knitr::include_graphics(file.path("../../results/plots/GSEA_IEL/GSEA_Reactome_IELTH17.png"))
```

**GO Biological Process**

```{r GSEA_GOBP_IELTH17}
knitr::include_graphics(file.path("../../results/plots/GSEA_IEL/GSEA_GOBP_IELTH17.png"))
```

**C7 ImmunoSigDB**

```{r GSEA_C7_IELTH17}
knitr::include_graphics(file.path("../../results/plots/GSEA_IEL/GSEA_C7_IELTH17.png"))
```
...
```{r GSEA_Hallmark_IELCytotoxicTRMlike}
knitr::include_graphics(file.path("../../results/plots/GSEA_IEL/GSEA_Hallmark_IELCytotoxicTRMlike.png"))
```

**Reactome**

```{r GSEA_Reactome_IELCytotoxicTRMlike}
knitr::include_graphics(file.path("../../results/plots/GSEA_IEL/GSEA_Reactome_IELCytotoxicTRMlike.png"))
```

**GO Biological Process**

```{r GSEA_GOBP_IELCytotoxicTRMlike}
knitr::include_graphics(file.path("../../results/plots/GSEA_IEL/GSEA_GOBP_IELCytotoxicTRMlike.png"))
```

**C7 ImmunoSigDB**

```{r GSEA_C7_IELCytotoxicTRMlike}
knitr::include_graphics(file.path("../../results/plots/GSEA_IEL/GSEA_C7_IELCytotoxicTRMlike.png"))
```
...
```{r GSEA_Hallmark_IELCyclingTcells}
knitr::include_graphics(file.path("../../results/plots/GSEA_IEL/GSEA_Hallmark_IELCyclingTcells.png"))
```

**Reactome**

```{r GSEA_Reactome_IELCyclingTcells}
knitr::include_graphics(file.path("../../results/plots/GSEA_IEL/GSEA_Reactome_IELCyclingTcells.png"))
```

**GO Biological Process**

```{r GSEA_GOBP_IELCyclingTcells}
knitr::include_graphics(file.path("../../results/plots/GSEA_IEL/GSEA_GOBP_IELCyclingTcells.png"))
```

**C7 ImmunoSigDB**

```{r GSEA_C7_IELCyclingTcells}
knitr::include_graphics(file.path("../../results/plots/GSEA_IEL/GSEA_C7_IELCyclingTcells.png"))
```
...
```{r GSEA_Hallmark_LPLCytotoxicTRMlike}
knitr::include_graphics(file.path("../../results/plots/GSEA_LPL/GSEA_Hallmark_LPLCytotoxicTRMlike.png"))
```

**Reactome**

```{r GSEA_Reactome_LPLCytotoxicTRMlike}
knitr::include_graphics(file.path("../../results/plots/GSEA_LPL/GSEA_Reactome_LPLCytotoxicTRMlike.png"))
```

**GO Biological Process**

```{r GSEA_GOBP_LPLCytotoxicTRMlike}
knitr::include_graphics(file.path("../../results/plots/GSEA_LPL/GSEA_GOBP_LPLCytotoxicTRMlike.png"))
```

**C7 ImmunoSigDB**

```{r GSEA_C7_LPLCytotoxicTRMlike}
knitr::include_graphics(file.path("../../results/plots/GSEA_LPL/GSEA_C7_LPLCytotoxicTRMlike.png"))
```
...
```{r GSEA_Hallmark_LPLTreg}
knitr::include_graphics(file.path("../../results/plots/GSEA_LPL/GSEA_Hallmark_LPLTreg.png"))
```

**Reactome**

```{r GSEA_Reactome_LPLTreg}
knitr::include_graphics(file.path("../../results/plots/GSEA_LPL/GSEA_Reactome_LPLTreg.png"))
```

**GO Biological Process**

```{r GSEA_GOBP_LPLTreg}
knitr::include_graphics(file.path("../../results/plots/GSEA_LPL/GSEA_GOBP_LPLTreg.png"))
```

**C7 ImmunoSigDB**

```{r GSEA_C7_LPLTreg}
knitr::include_graphics(file.path("../../results/plots/GSEA_LPL/GSEA_C7_LPLTreg.png"))
```
...
-   **TNFA Signaling via NF-κB** (down in CD, 4/5 cell types): extract
    the leading-edge genes from the stored `hallmark_list` objects and
    check whether the signal is driven by negative feedback regulators
