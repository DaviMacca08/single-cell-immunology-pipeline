...
message("Starting LIANA functional enrichment analysis for IEL compartment...")

# =========================================================
#                   Load input data
# =========================================================

message("Loading LIANA IEL disease-level results...")

liana_test_iel_disease <- readRDS(file.path(paths$objects_liana, "LIANA_IEL_bysample_disease_aggregated.rds"))
iel_cells <- readRDS(file.path(paths$objects_subsetting, "srt_IEL_compartment_celltype.rds"))

message("Loading IEL cell Seurat Object...")
...
# ============================================================
# Define adequately represented IEL populations
# ============================================================

message("Assessing IEL population representation across disease conditions...")
...
message("IEL populations retained for CD vs Control comparison: ", length(fully_comparable_types))

message("Excluded populations: ", sum(tier_iel$tier != "fully_comparable"))
...
res_ligand_compare <- liana_ora_lollipop_compare(
  ...
  title = "IEL — Ligand-side ORA, CD vs Control (Hallmark)"
)
...
res_receptor_compare <- liana_ora_lollipop_compare(
  ...
  title = "IEL — Receptor-side ORA, CD vs Control (Hallmark)"
)

message("Saving LIANA enrichment plots...")

open_png(filename = "LIANA_IEL_ORA_ligand_CDvsControl.png", dir = paths$plots_liana_iel,
...
open_png(filename = "LIANA_IEL_ORA_receptor_CDvsControl.png", dir = paths$plots_liana_iel,
         width = 3500, height = 2200)
...
save_rds(ora_cd, "LIANA_IEL_ORA_CD.rds", dir = paths$objects_liana)
save_rds(ora_ctrl, "LIANA_IEL_ORA_Control.rds", dir = paths$objects_liana)

save_rds(ora_ligand_compare, "LIANA_IEL_ORA_ligand_CDvsControl.rds", dir = paths$objects_liana)

save_rds(ora_receptor_compare, "LIANA_IEL_ORA_receptor_CDvsControl.rds", dir = paths$objects_liana)
...
save_session_info(filename = "sessionInfo_LIANA_IEL_ORA.txt", dir = paths$logs, label = "LIANA functional enrichment analysis - IEL compartment")
...
message("=================================================")
message("[PIPELINE] LIANA IEL functional enrichment completed successfully.")
