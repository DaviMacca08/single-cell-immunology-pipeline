...
cd_harmony <- readRDS(
  file.path(paths$objects_global, "srt_obj_annotated_SingleR.rds")
)
...
save_rds(cd_harmony, filename = "srt_obj_annotated_SingleR_Azimuth.rds", dir = paths$objects_global)
